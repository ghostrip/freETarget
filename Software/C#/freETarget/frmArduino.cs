...
namespace freETarget {
    public partial class frmArduino : Form {
        ...
        private void btnEcho_Click(object sender, EventArgs e) {
            mainWindow.SendDataToTarget("{\"ECHO\":0}");
        }

        private void btnInit_Click(object sender, EventArgs e) {
            mainWindow.SendDataToTarget("{\"INIT\":0}");
        }

        private void btnCalibration_Click(object sender, EventArgs e) {
            if (btnCalibration.Text == "CAL") {
                mainWindow.SendDataToTarget("{\"CAL\":0}");
                btnCalibration.Text = "STOP CAL";
            } else {
                //STOP CAL
                mainWindow.SendDataToTarget("!");
        ...
        private void btnVersion_Click(object sender, EventArgs e) {
            mainWindow.SendDataToTarget("{\"VERSION\":7}");
        }
        ...
        private void btnSend_Click(object sender, EventArgs e) {
            mainWindow.SendDataToTarget("{\"" + cmbCommands.SelectedItem.ToString() +  "\":" + txtParameter.Text + "}");
        }
